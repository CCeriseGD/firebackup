...
# Keyboard Commands Section            
            ...
            if message.lower() == 's' or message.lower() == 's':
                 PressAndHoldKey('s',2)
                 return
...
# There are no action chances these commands will always run reguardless of how often it is said in chat
            ...
            if message.lower() == 'left' or message.lower() == 'turn left' or message.lower() == 'a':
                PressAndHoldKey('left',0.03)
                return

            if message.lower() == 'right' or message.lower() == '->' or message.lower() == 'd':
                PressAndHoldKey('right',0.03)
                return
            
            if message.lower() == 'up' or message.lower() == 'forward' or message.lower() == 'w' or message.lower() == '^' or message.lower() == 'upward':
                PressAndHoldKey('up',10)
                return

            if message.lower() == 'down' or message.lower() == 'back' or message.lower() == 's' or message.lower() == 'v' or message.lower() == 'downward':
                PressAndHoldKey('down',10)
                return
...
#chaos
            if (message.lower() == 'chaos' or message.lower() == 'chaoschaos' or message.lower() == 'chaos chaos') and chaos < 100:
                chaos += 1
                print('current chaos')
                print(chaos)
                return
            
            if (message.lower() == 'order' or message.lower() == 'orderorder' or message.lower() == 'order order') and chaos > 0:
                chaos -= 1
                print('current chaos')
                print(chaos)
                return
            ...
            if message.lower() == 'maxorder' and chaos > 0:
                chaos = 0
                print('current chaos')
                print(chaos)
                return
            
            if message.lower() == 'maxchaos' and chaos < 100:
                chaos = 100
                print('current chaos')
                print(chaos)
                return
...
#checks
            if message.lower() == 'check chaos' or message.lower() == 'checkchaos':
                print('current chaos')
                print(chaos)
                print('current chaos')
                print(chaos)
                ...
                print(chaos)
                return
            if message.lower() == 'what mode' or message.lower() == 'mode is':
                print('Orderorder is')
                print(Orderorder)
                print('Orderorder is')
                print(Orderorder)
                ...
                print(Orderorder)
                return
            if message.lower() == 'what message' or message.lower() == 'message is':
                print('Message is')
                print(message)
                print('Message is')
                print(message)
...
#diagonals
            ...
            if message.lower() == 'up right' or message.lower() == 'right up' or message.lower() == 'right+up' or message.lower() == 'up+right' or message.lower() == 'w+d' or message.lower() == 'd+w'or message.lower() == '->+^' or message.lower() == '^+->':
                PressAndHold2Key("up","right",1) 
                return
            if message.lower() == 'down right' or message.lower() == 'right down' or message.lower() == 'right+down' or message.lower() == 'down+right' or message.lower() == 'w+d' or message.lower() == 'd+w'or message.lower() == '->+V' or message.lower() == 'V+->':
                PressAndHold2Key("down","right",1) 
                return
...
#Voting
            ...
            if Orderorder == True:
                if message.lower() == 'left' or message.lower() == 'turn left' or message.lower() == 'a':
                    votes['left'] += 1
                elif message.lower() == 'right' or message.lower() == '->' or message.lower() == 'd':
                    votes['right'] += 1
#initializing
...
# This is a command where hold key is useful
            ...
            if message.lower() == 'hold right' or message.lower() == 'hold d': 
               # if ActionChance(1,2) == 2:
                  #  break
                HoldKey('right')
               # PressAndHoldKey('z',0.01)
            if message.lower() == 'release right' or message.lower() == 'release d' or message.lower() == 'stop running':
                ReleaseKey('right')
                
            if message.lower() == 'stop' or message.lower() == 'stop please' or message.lower() == 'stop jeezus':
                ReleaseKey('right')
                ReleaseKey('left')
                ReleaseKey('up')
                ReleaseKey('escape')
